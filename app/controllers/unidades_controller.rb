class UnidadesController < ApplicationController
  ...
  private
    ...
    def unidade_params
      params.require(:unidade).permit(:cadastro_id, :insc_imob, :insc_imb_anterior, :unidade, :tipo_imovel, :matricula, :cod_face, :quadra, :lote, :sub_lote, :setor, :loteamento, :zoneamento, :logradouro, :cep, :numero, :complemento, :info_complementar)
    end
end
